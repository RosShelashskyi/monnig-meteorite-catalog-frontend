    ...
    export default {
        ...
        methods:{
            ...
            async archiveLoan(){
                await axios({
                    method: 'post',
                    url: 'https://monnig-meteorite-catalog.azurewebsites.net/api/loan/archive/' + this.$route.params.loan_id,
                    headers: {
                        'Authorization': 'Bearer ' + cacheUtils.get(0)
                    }
                });
            ...
            async unarchiveLoan(){
                await axios({
                    method: 'post',
                    url: 'https://monnig-meteorite-catalog.azurewebsites.net/api/loan/unarchive/' + this.$route.params.loan_id,
                    headers: {
                        'Authorization': 'Bearer ' + cacheUtils.get(0)
                    }
                });
