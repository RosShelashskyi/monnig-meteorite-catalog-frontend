        ...
        methods: {
            async fetchData(loan_id){
                try{
                    ...
                    const response = await axios({
                        method: 'get',
                        url: 'https://monnig-meteorite-catalog.azurewebsites.net/api/loan/view/' + loan_id,
                        headers :{
                    ...
                    console.log(this.loanData.samples_on_loan)
                    this.loanData.samples_on_loan = this.loanData.samples_on_loan.toString();
                }catch(error){
            ...
            async updateLoan(){
                ...
                try{
                    ...
                    await axios.put('https://monnig-meteorite-catalog.azurewebsites.net/api/loan/update/' + this.$route.params.loan_id, {
                        //request body
